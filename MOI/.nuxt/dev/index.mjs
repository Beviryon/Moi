...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, getResponseStatus, createError, removeResponseHeader, getQuery as getQuery$1, readBody, getCookie, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getResponseStatusText } from 'file://E:/Moi/MOI/node_modules/h3/dist/index.mjs';
import { escapeHtml } from 'file://E:/Moi/MOI/node_modules/@vue/shared/dist/shared.cjs.js';
import _RemarkEmoji from 'file://E:/Moi/MOI/node_modules/remark-emoji/index.js';
import { visit } from 'file://E:/Moi/MOI/node_modules/unist-util-visit/index.js';
import { toString } from 'file://E:/Moi/MOI/node_modules/hast-util-to-string/index.js';
import { createStorage, prefixStorage } from 'file://E:/Moi/MOI/node_modules/unstorage/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL, decodePath, withLeadingSlash, withoutTrailingSlash, isRelative } from 'file://E:/Moi/MOI/node_modules/ufo/dist/index.mjs';
import { hash as hash$1 } from 'file://E:/Moi/MOI/node_modules/ohash/dist/index.mjs';
import defu, { defuFn, defu as defu$1 } from 'file://E:/Moi/MOI/node_modules/defu/dist/defu.mjs';
import { dirname as dirname$1, resolve as resolve$1, extname } from 'file://E:/Moi/MOI/node_modules/pathe/dist/index.mjs';
import { snakeCase, kebabCase, pascalCase, camelCase } from 'file://E:/Moi/MOI/node_modules/scule/dist/index.mjs';
import { unified } from 'file://E:/Moi/MOI/node_modules/unified/index.js';
import { toString as toString$1 } from 'file://E:/Moi/MOI/node_modules/mdast-util-to-string/index.js';
import { postprocess, preprocess } from 'file://E:/Moi/MOI/node_modules/micromark/dev/index.js';
import { stringifyPosition } from 'file://E:/Moi/MOI/node_modules/unist-util-stringify-position/index.js';
import { markdownLineEnding, markdownSpace } from 'file://E:/Moi/MOI/node_modules/micromark-util-character/dev/index.js';
import { push, splice } from 'file://E:/Moi/MOI/node_modules/micromark-util-chunked/dev/index.js';
import { resolveAll } from 'file://E:/Moi/MOI/node_modules/micromark-util-resolve-all/index.js';
import { normalizeUri } from 'file://E:/Moi/MOI/node_modules/micromark-util-sanitize-uri/dev/index.js';
import remarkParse from 'file://E:/Moi/MOI/node_modules/remark-parse/index.js';
import remark2rehype from 'file://E:/Moi/MOI/node_modules/remark-rehype/index.js';
import remarkMDC, { parseFrontMatter } from 'file://E:/Moi/MOI/node_modules/remark-mdc/dist/index.mjs';
import remarkGFM from 'file://E:/Moi/MOI/node_modules/remark-gfm/index.js';
import rehypeExternalLinks from 'file://E:/Moi/MOI/node_modules/rehype-external-links/index.js';
import rehypeSortAttributeValues from 'file://E:/Moi/MOI/node_modules/rehype-sort-attribute-values/index.js';
import rehypeSortAttributes from 'file://E:/Moi/MOI/node_modules/rehype-sort-attributes/index.js';
import rehypeRaw from 'file://E:/Moi/MOI/node_modules/rehype-raw/index.js';
import { detab } from 'file://E:/Moi/MOI/node_modules/detab/index.js';
import Slugger from 'file://E:/Moi/MOI/node_modules/github-slugger/index.js';
import destr, { destr as destr$1 } from 'file://E:/Moi/MOI/node_modules/destr/dist/index.mjs';
import { createWasmOnigEngine } from 'file://E:/Moi/MOI/node_modules/shiki/dist/engine-oniguruma.mjs';
import slugify from 'file://E:/Moi/MOI/node_modules/slugify/slugify.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file://E:/Moi/MOI/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { renderToString } from 'file://E:/Moi/MOI/node_modules/vue/server-renderer/index.mjs';
import { klona } from 'file://E:/Moi/MOI/node_modules/klona/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file://E:/Moi/MOI/node_modules/nuxt/node_modules/unhead/dist/server.mjs';
import { stringify, uneval } from 'file://E:/Moi/MOI/node_modules/devalue/index.js';
import { isVNode, toValue, isRef } from 'file://E:/Moi/MOI/node_modules/vue/index.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file://E:/Moi/MOI/node_modules/nuxt/node_modules/unhead/dist/plugins.mjs';
import { createHooks } from 'file://E:/Moi/MOI/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file://E:/Moi/MOI/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file://E:/Moi/MOI/node_modules/node-mock-http/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://E:/Moi/MOI/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file://E:/Moi/MOI/node_modules/nitropack/node_modules/ohash/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file://E:/Moi/MOI/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file://E:/Moi/MOI/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file://E:/Moi/MOI/node_modules/youch-core/build/index.js';
import { Youch } from 'file://E:/Moi/MOI/node_modules/nitropack/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file://E:/Moi/MOI/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { getContext } from 'file://E:/Moi/MOI/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://E:/Moi/MOI/node_modules/errx/dist/index.js';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { walkResolver } from 'file://E:/Moi/MOI/node_modules/nuxt/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"E:/Moi/MOI/server/assets"}];
...
storage$1.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"E:/Moi/MOI","watchOptions":{"ignored":[null]}}));
storage$1.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"E:/Moi/MOI/server","watchOptions":{"ignored":[null]}}));
storage$1.mount('content:source:content', unstorage_47drivers_47fs({"name":"content:source:content","driver":"fs","base":"E:/Moi/MOI/content"}));
storage$1.mount('cache:content', unstorage_47drivers_47fs({"driver":"fs","base":"E:/Moi/MOI/.nuxt/content-cache"}));
storage$1.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"E:/Moi/MOI/.nuxt"}));
storage$1.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"E:/Moi/MOI/.nuxt/cache"}));
storage$1.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"E:/Moi/MOI/.data/kv"}));
...
const _fLXeAGPN3Sb0Do6h3gMVRbMfbZMzBHNX3nQrf2ymRZ8 = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "E:/Moi/MOI";

const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"Portfolio of Beviryon Issanga Ngoulou - Expert Fullstack Developer specializing in Vue.js, AdonisJS, and modern web technologies"},{"name":"keywords","content":"fullstack developer, vue.js, adonisjs, nuxt, javascript, typescript, web development"},{"name":"author","content":"Beviryon Issanga Ngoulou"},{"property":"og:title","content":"Beviryon Issanga Ngoulou - Fullstack Developer"},{"property":"og:description","content":"Portfolio of Beviryon Issanga Ngoulou - Expert Fullstack Developer"},{"property":"og:type","content":"website"},{"property":"og:url","content":"https://beviryon.dev"},{"name":"twitter:card","content":"summary_large_image"},{"name":"twitter:title","content":"Beviryon Issanga Ngoulou - Fullstack Developer"},{"name":"twitter:description","content":"Portfolio of Beviryon Issanga Ngoulou - Expert Fullstack Developer"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"}],"style":[],"script":[],"noscript":[],"title":"Beviryon Issanga Ngoulou - Fullstack Developer"};
...
const _tCcAt90m_zBtlGof0dmiWCN0VUOzXihD97kWadMtLk = (nitroApp) => {
...
const _gVXfxtmA8fS0BvFljorsjVqcmdlclsEyWGYEl12oc = defineNitroPlugin(async (nitro) => {
...
const plugins = [
  _fLXeAGPN3Sb0Do6h3gMVRbMfbZMzBHNX3nQrf2ymRZ8,
_tCcAt90m_zBtlGof0dmiWCN0VUOzXihD97kWadMtLk,
_gVXfxtmA8fS0BvFljorsjVqcmdlclsEyWGYEl12oc
];
...
const getServerEntry = () => import('file://E:/Moi/MOI/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file://E:/Moi/MOI/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _lazy_L9HANw = () => Promise.resolve().then(function () { return renderer$1; });
...
const handlers = [
  ...
  { route: '/api/_content/cache.json', handler: _whTRMy, lazy: false, middleware: false, method: "get" },
  ...
  parse: async (_id, content) => {
    ...
    if (typeof content === "string") {
      if (_id.endsWith("json5")) {
        parsed = (await import('file://E:/Moi/MOI/node_modules/json5/lib/index.js').then((m) => m.default || m)).parse(content);
...
function createShikiHighlighter({
  ...
  async function _getShiki() {
    const { createHighlighterCore, addClassToHast, isSpecialLang, isSpecialTheme } = await import('file://E:/Moi/MOI/node_modules/shiki/dist/core-unwasm.mjs');
    const { transformerNotationDiff, transformerNotationErrorLevel, transformerNotationFocus, transformerNotationHighlight } = await import('file://E:/Moi/MOI/node_modules/@shikijs/transformers/dist/index.mjs');
...
const bundledLangs = {
"javascript": () => import('file://E:/Moi/MOI/node_modules/shiki/dist/langs/javascript.mjs'),
"js": () => import('file://E:/Moi/MOI/node_modules/shiki/dist/langs/javascript.mjs'),
"jsx": () => import('file://E:/Moi/MOI/node_modules/shiki/dist/langs/jsx.mjs'),
"json": () => import('file://E:/Moi/MOI/node_modules/shiki/dist/langs/json.mjs'),
"typescript": () => import('file://E:/Moi/MOI/node_modules/shiki/dist/langs/typescript.mjs'),
"ts": () => import('file://E:/Moi/MOI/node_modules/shiki/dist/langs/typescript.mjs'),
"tsx": () => import('file://E:/Moi/MOI/node_modules/shiki/dist/langs/tsx.mjs'),
"vue": () => import('file://E:/Moi/MOI/node_modules/shiki/dist/langs/vue.mjs'),
"css": () => import('file://E:/Moi/MOI/node_modules/shiki/dist/langs/css.mjs'),
"html": () => import('file://E:/Moi/MOI/node_modules/shiki/dist/langs/html.mjs'),
"shellscript": () => import('file://E:/Moi/MOI/node_modules/shiki/dist/langs/shellscript.mjs'),
"bash": () => import('file://E:/Moi/MOI/node_modules/shiki/dist/langs/shellscript.mjs'),
"sh": () => import('file://E:/Moi/MOI/node_modules/shiki/dist/langs/shellscript.mjs'),
"shell": () => import('file://E:/Moi/MOI/node_modules/shiki/dist/langs/shellscript.mjs'),
"zsh": () => import('file://E:/Moi/MOI/node_modules/shiki/dist/langs/shellscript.mjs'),
"markdown": () => import('file://E:/Moi/MOI/node_modules/shiki/dist/langs/markdown.mjs'),
"md": () => import('file://E:/Moi/MOI/node_modules/shiki/dist/langs/markdown.mjs'),
"mdc": () => import('file://E:/Moi/MOI/node_modules/shiki/dist/langs/mdc.mjs'),
"yaml": () => import('file://E:/Moi/MOI/node_modules/shiki/dist/langs/yaml.mjs'),
"yml": () => import('file://E:/Moi/MOI/node_modules/shiki/dist/langs/yaml.mjs'),
};
const bundledThemes = {
"github-dark": () => import('file://E:/Moi/MOI/node_modules/shiki/dist/themes/github-dark.mjs').then(r => r.default),
};
const options = {};
const engine = createWasmOnigEngine(() => Promise.resolve().then(function () { return onig; }));
...
const _imports = {
  env: {
    emscripten_memcpy_big: () => { throw new Error("env._imports_env" + " is not provided!")},
    emscripten_get_now: () => { throw new Error("env._imports_env" + " is not provided!")},
    emscripten_resize_heap: () => { throw new Error("env._imports_env" + " is not provided!")}
  },
  wasi_snapshot_preview1: {
    fd_write: () => { throw new Error("wasi_snapshot_preview1._imports_wasi_snapshot_preview1" + " is not provided!")}
  }
};
...
const onig = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
