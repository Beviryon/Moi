...
import { _ as _sfc_main$3 } from "./Icon-CPeZLWXG.js";
import { defineComponent, ref, mergeProps, withCtx, createTextVNode, toDisplayString, useSSRContext, computed, unref, readonly, watch, createVNode } from "vue";
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrRenderClass, ssrRenderStyle, ssrRenderAttr, ssrIncludeBooleanAttr, ssrRenderSlot } from "vue/server-renderer";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></div></div></div><div class="border-t border-gray-700/50 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0"><p class="text-gray-400 dark:text-gray-300 text-sm"> © ${ssrInterpolate(unref(currentYear))} Beviryon Issanga Ngoulou. All rights reserved. </p><div class="flex space-x-6">`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/privacy",
...
//# sourceMappingURL=default-rNZcPFzF.js.map
