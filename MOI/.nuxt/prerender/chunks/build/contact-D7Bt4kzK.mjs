...
import { defineComponent, ref, reactive, mergeProps, unref, withCtx, createTextVNode, useSSRContext } from 'file://E:/Moi/MOI/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderAttr, ssrRenderClass, ssrInterpolate, ssrIncludeBooleanAttr, ssrLooseContain, ssrRenderComponent, ssrRenderList } from 'file://E:/Moi/MOI/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div><p class="text-sm text-gray-400">Location</p><p class="text-gray-200">Paris, \xCEle-de-France</p></div></div><div class="flex items-center space-x-4"><div class="w-12 h-12 bg-primary-600/20 rounded-lg flex items-center justify-center">`);
      _push(ssrRenderComponent(_component_Icon, {
...
//# sourceMappingURL=contact-D7Bt4kzK.mjs.map
