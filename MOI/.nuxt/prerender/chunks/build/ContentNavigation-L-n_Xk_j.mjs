import { defineComponent, useSlots, h, toRefs, computed, toRef, isRef, useSSRContext } from 'file://E:/Moi/MOI/node_modules/vue/index.mjs';
import { hash } from 'file://E:/Moi/MOI/node_modules/ohash/dist/index.mjs';
import { u as useAsyncData } from './asyncData-CYkp8Zjf.mjs';
import { u as useContentDisabled, q as queryContent, w as withContentBase, e as encodeQueryParams, a as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './query-BlOO9W2B.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-C2G7Ierj.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-L-n_Xk_j.mjs.map
