import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, inject, getCurrentInstance, defineComponent, createElementBlock, shallowRef, provide, cloneVNode, h, defineAsyncComponent, computed, unref, shallowReactive, ref, Suspense, Fragment, useSSRContext, createApp, withCtx, createVNode, toRef, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, reactive, effectScope, isReadonly, isRef, isShallow, isReactive, toRaw, nextTick, mergeProps, getCurrentScope, markRaw } from 'file://E:/Moi/MOI/node_modules/vue/index.mjs';
import { $fetch } from 'file://E:/Moi/MOI/node_modules/ofetch/dist/node.mjs';
import { h as baseURL } from '../_/nitro.mjs';
import { createHooks } from 'file://E:/Moi/MOI/node_modules/hookable/dist/index.mjs';
import { getContext, executeAsync } from 'file://E:/Moi/MOI/node_modules/unctx/dist/index.mjs';
import { createError as createError$1, sanitizeStatusCode } from 'file://E:/Moi/MOI/node_modules/h3/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file://E:/Moi/MOI/node_modules/vue-router/dist/vue-router.node.mjs';
import { toRouteMatcher, createRouter as createRouter$1 } from 'file://E:/Moi/MOI/node_modules/radix3/dist/index.mjs';
import { defu } from 'file://E:/Moi/MOI/node_modules/defu/dist/defu.mjs';
import { hasProtocol, isScriptProtocol, joinURL, withQuery } from 'file://E:/Moi/MOI/node_modules/ufo/dist/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderSuspense, ssrRenderVNode } from 'file://E:/Moi/MOI/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    name: "blog",
    path: "/blog",
    component: () => import('./blog-BeRN938d.mjs'),
    children: [
      {
        name: "blog-slug",
        path: ":slug(.*)*",
        component: () => import('./_...slug_-B9CyhnVv.mjs')
      }
    ]
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-K90d-0A3.mjs')
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import('./contact-D7Bt4kzK.mjs')
  },
  {
    name: "privacy",
    path: "/privacy",
    component: () => import('./privacy-qbH6747W.mjs')
  }
];
...
const LazyContentDoc = defineAsyncComponent(() => import('./ContentDoc-BcT6BnUT.mjs').then((r) => r["default"] || r.default || r));
const LazyContentList = defineAsyncComponent(() => import('./ContentList-CxEoTdNA.mjs').then((r) => r["default"] || r.default || r));
const LazyContentNavigation = defineAsyncComponent(() => import('./ContentNavigation-L-n_Xk_j.mjs').then((r) => r["default"] || r.default || r));
const LazyContentQuery = defineAsyncComponent(() => import('./ContentQuery-Dp57_s1D.mjs').then((r) => r["default"] || r.default || r));
const LazyContentRenderer = defineAsyncComponent(() => import('./ContentRenderer-D_yKMV8C.mjs').then((r) => r["default"] || r.default || r));
const LazyContentRendererMarkdown = defineAsyncComponent(() => import('./ContentRendererMarkdown-tkJSdaSd.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseA = defineAsyncComponent(() => import('./ProseA-jToE2OM6.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseH1 = defineAsyncComponent(() => import('./ProseH1-Cv8wkFzX.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH2 = defineAsyncComponent(() => import('./ProseH2-vn-H6Wx6.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH3 = defineAsyncComponent(() => import('./ProseH3-Coq1mNB2.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH4 = defineAsyncComponent(() => import('./ProseH4-ZnJvSDoK.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH5 = defineAsyncComponent(() => import('./ProseH5-BFOwLn-5.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH6 = defineAsyncComponent(() => import('./ProseH6-BPdQMgqH.mjs').then((r) => r["default"] || r.default || r));
const LazyProseHr = defineAsyncComponent(() => import('./ProseHr-Bidow6pB.mjs').then((r) => r["default"] || r.default || r));
const LazyProseImg = defineAsyncComponent(() => import('./ProseImg-l0sj_BbW.mjs').then((r) => r["default"] || r.default || r));
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-rNZcPFzF.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CkhD6bra.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DvYhYR4E.mjs'));
...
export { useRoute as a, useRuntimeConfig as b, useNuxtApp as c, asyncDataDefaults as d, entry$1 as default, createError as e, useRouter as f, nuxtLinkDefaults as g, navigateTo as n, resolveRouteObject as r, useHead as u };
