<template>
  <div class="min-h-screen py-20 px-4 sm:px-6 lg:px-8">
    <div class="max-w-4xl mx-auto">
      ...
      <!-- Content -->
      <div ref="content" class="prose prose-lg prose-invert max-w-none">
        <div class="card">
          <h2 class="text-2xl font-display font-bold text-gray-200 mb-6">
            Introduction
          </h2>
          <p class="text-gray-300 mb-6">
            Beviryon Issanga Ngoulou ("I", "me", or "my") operates the website beviryon.dev (the "Service"). 
          ...
          <h3 class="text-xl font-semibold text-gray-200 mb-4">Types of Data Collected</h3>
          
          <h4 class="text-lg font-medium text-gray-200 mb-3">Personal Data</h4>
          <p class="text-gray-300 mb-4">
            While using my Service, I may ask you to provide me with certain personally identifiable information 
          ...
          <h4 class="text-lg font-medium text-gray-200 mb-3">Usage Data</h4>
          <p class="text-gray-300 mb-6">
            I may also collect information on how the Service is accessed and used ("Usage Data"). 
            This Usage Data may include information such as your computer's Internet Protocol address (e.g. IP address), 
            browser type, browser version, the pages of my Service that you visit, the time and date of your visit, 
            the time spent on those pages, unique device identifiers and other diagnostic data.
          </p>

          <h4 class="text-lg font-medium text-gray-200 mb-3">Tracking & Cookies Data</h4>
          <p class="text-gray-300 mb-4">
          ...
          <p class="text-gray-300 mb-4">
            Beviryon Issanga Ngoulou uses the collected data for various purposes:
          </p>
          <ul class="list-disc list-inside text-gray-300 mb-6 space-y-2">
          ...
          <ul class="list-disc list-inside text-gray-300 mb-6 space-y-2">
            ...
            <li>To protect and defend the rights or property of Beviryon Issanga Ngoulou</li>
          ...
          <p class="text-gray-300 mb-6">
            ...
            or method of electronic storage is 100% secure. While I strive to use commercially acceptable means to protect your Personal Data, 
          ...
          <p class="text-gray-300 mb-4">
            I may employ third party companies and individuals to facilitate my Service ("Service Providers"), 
            to provide the Service on my behalf, to perform Service-related services or to assist me in analyzing how my Service is used.
          </p>
          <p class="text-gray-300 mb-6">
          ...
          <p class="text-gray-300 mb-6">
            My Service may contain links to other sites that are not operated by me. If you click on a third party link, 
            you will be directed to that third party's site. I strongly advise you to review the Privacy Policy of every site you visit.
          </p>
          ...
          <p class="text-gray-300 mb-6">
            My Service does not address anyone under the age of 18 ("Children"). I do not knowingly collect personally identifiable information from anyone under the age of 18. 
            If you are a parent or guardian and you are aware that your Children has provided me with Personal Data, please contact me.
          </p>
          ...
          <div class="bg-gray-800/50 rounded-lg p-6">
            <p class="text-gray-300 mb-2">
              <strong>Email:</strong> 
              <a href="mailto:contact@beviryon.dev" class="text-primary-400 hover:text-primary-300 transition-colors duration-200">
                contact@beviryon.dev
              </a>
            </p>
            <p class="text-gray-300">
              <strong>Website:</strong> 
              <a href="https://beviryon.dev" class="text-primary-400 hover:text-primary-300 transition-colors duration-200">
                https://beviryon.dev
              </a>
            </p>
          </div>
